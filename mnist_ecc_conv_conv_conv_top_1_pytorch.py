...
layer1_save_file = 'mnist_ecc_conv_conv_conv_top_1_pytorch layer1.model'
layer2_save_file = 'mnist_ecc_conv_conv_conv_top_1_pytorch layer2.model'
layer3_save_file = 'mnist_ecc_conv_conv_conv_top_1_pytorch layer3.model'
...
class D(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        l1_out = l1.infer(sdr)
        l2_out = l2.infer(l1_out)
        l3_out = l3.infer(l2_out)
        img = torch.zeros(l3.out_volume)
        img[list(l3_out)] = 1
...
linear = torch.nn.Linear(l3.out_volume, 10)
...
# if you set l3_col.out_channels==64  l3_col.k==4
#    train= 0.95265 eval= 0.96305
#    train= 0.983425 eval= 0.9659
