...
z = 1 / (1+y_f32)
assert str(z) == "[[1, 0.5, 0.33333334], [0.25, 0.2, 0.16666667], [0.14285715, 0.125, 0.11111111]]", str(z)
z = 1 + x
assert str(z) == "[[1, 2, 1], [2, 1, 1], [1, 1, 2]]", str(z)
z = 100*y_f32
assert str(z) == "[[0, 100, 200], [300, 400, 500], [600, 700, 800]]", str(z)
z = nd.exp(y)
assert str(z) == "[[1, 2.7182817, 7.389056], [20.085537, 54.59815, 148.41316], [403.4288, 1096.6332, 2980.958]]", str(z)
z = nd.exp(y_f32)
assert str(z) == "[[1, 2.7182817, 7.389056], [20.085537, 54.59815, 148.41316], [403.4288, 1096.6332, 2980.958]]", str(z)
z = nd.log(y)
assert str(z) == "[[-inf, 0, 0.6931472], [1.0986123, 1.3862944, 1.609438], [1.7917595, 1.9459101, 2.0794415]]", str(z)
z = nd.log(y_f32)
assert str(z) == "[[-inf, 0, 0.6931472], [1.0986123, 1.3862944, 1.609438], [1.7917595, 1.9459101, 2.0794415]]", str(z)
z = nd.sin(y)
assert str(z) == "[[0, 0.84147096, 0.9092974], [0.14112, -0.7568025, -0.9589243], [-0.2794155, 0.6569866, 0.98935825]]", str(z)
z = nd.sin(y_f32)
assert str(z) == "[[0, 0.84147096, 0.9092974], [0.14112, -0.7568025, -0.9589243], [-0.2794155, 0.6569866, 0.98935825]]", str(z)
z = nd.cos(y)
assert str(z) == "[[1, 0.5403023, -0.41614684], [-0.9899925, -0.6536436, 0.2836622], [0.96017027, 0.75390226, -0.14550003]]", str(z)
z = nd.cos(y_f32)
assert str(z) == "[[1, 0.5403023, -0.41614684], [-0.9899925, -0.6536436, 0.2836622], [0.96017027, 0.75390226, -0.14550003]]", str(z)
z = nd.tan(y)
assert str(z) == "[[0, 1.5574077, -2.1850398], [-0.14254655, 1.1578213, -3.380515], [-0.29100618, 0.871448, -6.799711]]", str(z)
z = nd.tan(y_f32)
assert str(z) == "[[0, 1.5574077, -2.1850398], [-0.14254655, 1.1578213, -3.380515], [-0.29100618, 0.871448, -6.799711]]", str(z)
z = nd.tanh(y)
