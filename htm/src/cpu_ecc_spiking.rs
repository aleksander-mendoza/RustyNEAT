...
// use crate::{Shape, resolve_range, EncoderTarget, Synapse, top_large_k_indices, top_small_k_indices, Shape3, from_xyz, Shape2, from_xy, range_contains, DenseWeight, w_idx, kernel_column_weight_sum, debug_assert_approx_eq_weight, EccLayerD, kernel_column_dropped_weights_count, ConvShape, ConvWeights, CpuEccMachine, ConvShapeTrait, ConvWeightVec, HasShape};
...
// }
//
// impl<D: DenseWeight> EccLayer for CpuEccSpiDense<D> {
//     type A = CpuSDR;
//
