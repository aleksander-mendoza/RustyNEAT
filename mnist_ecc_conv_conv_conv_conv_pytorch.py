...
layer1_save_file = 'mnist_ecc_conv_conv_conv_conv_pytorch layer1.model'
layer2_save_file = 'mnist_ecc_conv_conv_conv_conv_pytorch layer2.model'
layer3_save_file = 'mnist_ecc_conv_conv_conv_conv_pytorch layer3.model'
layer4_save_file = 'mnist_ecc_conv_conv_conv_conv_pytorch layer4.model'
...
if os.path.exists(layer4_save_file):
    ...
    l4_col = ecc.CpuEccDense(output=[1, 1], kernel=l3.out_shape[:2], stride=[1, 1], in_channels=l3.out_channels,
...
# train= 0.595775 eval= 0.6973
# train= 0.69705 eval= 0.7028
# train= 0.7033 eval= 0.70885
