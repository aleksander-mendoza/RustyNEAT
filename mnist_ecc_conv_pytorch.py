...
m = ecc.CpuEccDense(output=[1, 1], kernel=[5, 5], stride=[1, 1],
                    in_channels=1, out_channels=40, k=1)
...
# results if PRETRAIN==False
#   train= 0.9354 eval= 0.9644
#   train= 0.988525 eval= 0.96535
#   train= 0.997725 eval= 0.9676
# results if PRETRAIN==True
#   train= 0.954525 eval= 0.9732
#   train= 0.991675 eval= 0.9744
